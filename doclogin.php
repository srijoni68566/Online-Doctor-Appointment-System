...
<head>
  ...
  <link href="css/style.css" rel="stylesheet" type="text/css">
  	<h6 align="right" style="margin-right:20px; margin-top:20px;"><a href="index.php"style="color:#fff;">Home</a></h6>
  	<h6 align="right" style="margin-right:20px; margin-top:20px;"><a href="reg.php"style="color:#fff;">Register</a></h6>
	<h6 align="right" style="margin-right:20px; margin-top:20px;"><a href="verify.php"style="color:#fff;">Verification</a></h6>

	</head>
	<style>
  .form-container{
	boder:0px solid #fff;padding:50px 60px;margin-top:4vh;
	margin-right:400px;
	margin-left:400px;
	...
	<span>
	 ...
	 <form action="doclogin.php" method="post">
		...
		<table align="center">
			...
			<tr>
	 <td colspan="2" align="center"><input type="submit" class="btn btn-info" name="login"  value="Login"></td>
